...
/**
 ...
 LCD character displays can be found in many devices, like espresso machines,
 laser printers. The Hitachi HD44780 controller and its compatible controllers
 like Samsung KS0066U have become an industry standard for these types of
 displays.

 This library allows easy interfacing with a HD44780 compatible display and can
 be operated in memory mapped mode (LCD_IO_MODE defined as 0 in the include file
 lcd.h.) or in 4-bit IO port mode (LCD_IO_MODE defined as 1). 8-bit IO port mode
 is not supported.

 Memory mapped mode is compatible with old Kanda STK200 starter kit, but also
 supports generation of R/W signal through A8 address line.

 @see The chapter <a href="
 http://homepage.hispeed.ch/peterfleury/avr-lcd44780.html"
 target="_blank">Interfacing a HD44780 Based LCD to an AVR</a> on my home page,
 which shows example circuits how to connect an LCD to an AVR controller.
...
#error                                                                         \
    "This library requires AVR-GCC 4.5 or later, update to newer AVR-GCC compiler !"
#endif

/**@{*/

/*
 * LCD and target specific definitions below can be defined in a separate
 * include file with name lcd_definitions.h instead modifying this file by
 * adding -D_LCD_DEFINITIONS_FILE to the CDEFS section in the Makefile All
 * definitions added to the file lcd_definitions.h will override the default
 ...
 *
 * These definitions can be defined in a separate include file \b
 * lcd_definitions.h instead modifying this file by adding
 * -D_LCD_DEFINITIONS_FILE to the CDEFS section in the Makefile. All definitions
 * added to the file lcd_definitions.h will override the default definitions
 * from lcd.h
 *
 */
#ifndef LCD_LINES
 ...
 * different ports by adapting the LCD_DATAx_PORT and LCD_DATAx_PIN definitions.
 *
 * Adjust these definitions to your target.\n
 * These definitions can be defined in a separate include file \b
 * lcd_definitions.h instead modifying this file by adding \b
 * -D_LCD_DEFINITIONS_FILE to the \b CDEFS section in the Makefile. All
 * definitions added to the file lcd_definitions.h will override the default
 * definitions from lcd.h
 *
 */
...
#define LCD_DATA0_PIN PE5 /**< pin for 4bit data bit 0  */
#endif
#ifndef LCD_DATA1_PIN
#define LCD_DATA1_PIN PG5 /**< pin for 4bit data bit 1  */
#endif
#ifndef LCD_DATA2_PIN
#define LCD_DATA2_PIN PE3 /**< pin for 4bit data bit 2  */
#endif
#ifndef LCD_DATA3_PIN
#define LCD_DATA3_PIN PH3 /**< pin for 4bit data bit 3  */
#endif
#ifndef LCD_RS_PORT
#define LCD_RS_PORT PORTH /**< port for RS line         */
#endif
#ifndef LCD_RS_PIN
#define LCD_RS_PIN PH6 /**< pin  for RS line         */
#endif
#ifndef LCD_RW_PORT
#define LCD_RW_PORT PORTB /**< port for RW line         */
#endif
#ifndef LCD_RW_PIN
#define LCD_RW_PIN PB4 /**< pin  for RW line         */
#endif
#ifndef LCD_E_PORT
#define LCD_E_PORT PORTB /**< port for Enable line     */
#endif
#ifndef LCD_E_PIN
#define LCD_E_PIN PB5 /**< pin  for Enable line     */
#endif
...
#else
#error                                                                         \
    "external data memory interface not available for this device, use 4-bit IO port mode"
 ...
 * Adapt the F_CPU define in the Makefile to the clock frequency in Hz of your
 * target
 *
 * These delay times can be adjusted, if some displays require different
 * delays.\n These definitions can be defined in a separate include file \b
 * lcd_definitions.h instead modifying this file by adding \b
 * -D_LCD_DEFINITIONS_FILE to the \b CDEFS section in the Makefile. All
 * definitions added to the file lcd_definitions.h will override the default
