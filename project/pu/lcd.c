...
static void lcd_write(uint8_t data, uint8_t rs)
{
    ...
    if ((&LCD_DATA0_PORT == &LCD_DATA1_PORT) &&
        ...
        (&LCD_DATA2_PORT == &LCD_DATA3_PORT) && (LCD_DATA0_PIN == 0) &&
        (LCD_DATA1_PIN == 1) && (LCD_DATA2_PIN == 2) && (LCD_DATA3_PIN == 3)) {
...
#else
#define lcd_read(rs)                                                           \
    (rs) ? *(volatile uint8_t *)(LCD_IO_DATA + LCD_IO_READ)                    \
...
void lcd_init(uint8_t dispAttr)
{
    ...
    if ((&LCD_DATA0_PORT == &LCD_DATA1_PORT) &&
        ...
        (&LCD_RW_PORT == &LCD_DATA0_PORT) && (&LCD_E_PORT == &LCD_DATA0_PORT) &&
        (LCD_DATA0_PIN == 0) && (LCD_DATA1_PIN == 1) && (LCD_DATA2_PIN == 2) &&
        (LCD_DATA3_PIN == 3) && (LCD_RS_PIN == 4) && (LCD_RW_PIN == 5) &&
        (LCD_E_PIN == 6)) {
        ...
        DDR(LCD_DATA0_PORT) |= 0x7F;
             ...
             (&LCD_DATA1_PORT == &LCD_DATA2_PORT) &&
             (&LCD_DATA2_PORT == &LCD_DATA3_PORT) && (LCD_DATA0_PIN == 0) &&
             (LCD_DATA1_PIN == 1) && (LCD_DATA2_PIN == 2) &&
             (LCD_DATA3_PIN == 3)) {
